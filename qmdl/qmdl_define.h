...
#define QCD_CHANGE							0x0301				// 改变编码
#define QCD_CLICK							0x0302				// 点击编码
#define QCD_DBLCLK							0x0303				// 双击编码
#define QCD_TAP								0x0304				// 单击或多击编码
#define QCD_PAN								0x0305				// 拖动编码
#define QCD_PINCH							0x0306				// 缩放编码
#define QCD_SWIPE							0x0307				// 擦碰编码
#define QCD_ROTATION						0x0308				// 旋转编码
#define QCD_LONGPRESS						0x0309				// 长按编码
